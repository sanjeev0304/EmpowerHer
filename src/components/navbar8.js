                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Welcome to AI for Women Entrepreneurs
                                </span>
                              </Fragment>
                            )}
                          </span>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text20">About Us</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text26">
                                  Explore the AI services we offer
                                </span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text14">
                                  Get in touch with us for collaborations and
                                  inquiries
                                </span>
                              </Fragment>
                            )}
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1432821596592-e2c18b78144f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzE5NjMwNHw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  page2ImageAlt: 'About Us Image',
  link2: undefined,
  linkUrlPage2: 'https://www.teleporthq.io',
  logoAlt: 'AI for Women Entrepreneurs Logo',
  logoSrc:
  ...
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1580196979617-7c9df939e6b6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzE5NjMwNHw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1522071820081-009f0129c71c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzE5NjMwNHw&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1551024709-8f23befc6f87?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzE5NjMwNXw&ixlib=rb-4.0.3&q=80&w=1080',
  page2Description: undefined,
  link3: undefined,
  page3: undefined,
  link1Url: 'https://www.teleporthq.io',
  page3Description: undefined,
  page1ImageAlt: 'AI for Women Entrepreneurs Logo',
  action2: undefined,
